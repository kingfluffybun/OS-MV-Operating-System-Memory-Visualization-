...
// =====================================================
// SEGMENTATION ALGORITHM INTEGRATION
// =====================================================
...
const runSegmentationStep = () => {
  ...
  updateStatistics({
    ...
    totalFree,
    intFragmentation: 0,
    externalFragmentation: totalFree,
    memoryUtilization,
    successRate,
  });
...
prepareSimulation = function () {
  ...
  return originalPrepareSimulation.call(this);
};

// =====================================================
// END SEGMENTATION INTEGRATION
// =====================================================
  ...
  if (
    ...
    switch (algoWhat) {
      case "Paging":
        ...
        break;
      case "Segmentation":
        window.location.href = `algorithm/simulation-Segmentation.html?algorithm=segmentation`;
        break;
    }
  }
}
